...
public class Airport {
    ...
    public List<PassengerPlane> getPassengerPlanes() { // 'getPasPl' was replaced by 'getPassengerPlanes'
        List<PassengerPlane> passengerPlanes = new ArrayList<>();
        for (Plane plane : planes) { // 'x and l' variables were removed and replaced
